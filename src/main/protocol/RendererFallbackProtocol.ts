...
import {
  ...
  type CompleteChatRequest as ModelCompleteChatRequest,
  type ModelStreamEventHandler
} from '../../shared/agent/ModelAdapter';
import { assertPathInsideRoot, saveSessionAsmFile, type SavedAsmFile } from '../../shared/project/SessionFileStore';
...
export async function createRendererFallbackResponse(
  request: Request,
  dependencies: RendererFallbackDependencies = buildDefaultDependencies()
): Promise<Response> {
